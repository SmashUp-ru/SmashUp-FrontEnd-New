        ...
        <div className='px-8 flex flex-col gap-8'>
            <div className='flex flex-row bg-surfaceVariant w-full h-[238px] rounded-4xl px-6 py-6 gap-12'>
                ...
                <div className='flex flex-col justify-center gap-2.5'>
                    <h1 className='font-semibold text-5xl text-onSurface'>{transl('track.name')}</h1>
                    <span className='font-medium text-base text-onSurfaceVariant'>{transl('track.artist')}</span>
                </div>
            </div>
